    ...
    def test_planning_agent(self):
        ...
        while True:
            ...
            if first_question is None:
                ...
                planning_agent: Agent = AgentManager().get_instance_obj('ob_dba_planning_agent')
                output_object: OutputObject = planning_agent.run(input=user_input, chat_history=history)
